        ...
        <>
            ...
            <main className="Main_Box">
                ...
                <div className="context">
                    ...
                    <div className="caution-text-p">헌법재판소에서 법률의 위헌결정, 탄핵의 결정, 정당해산의 결정 또는 헌법소원에 관한 인용결정을 할 때에는 재판관 6인 이상의 찬성이 있어야 한다. 국가안전보장에 관련되는 대외정책·군사정책과 국내정책의 수립에 관하여 국무회의의 심의에 앞서 대통령의 자문에 응하기 위하여 국가안전보장회의를 둔다.</div>
                </div>
                ...
                <div className="context">
                    ...
                    <div className="caution-text-h2">사과가 너무 맛있을 수 있습니다.</div>
                    <div className="caution-text-h1">정성으로 키웠으니까!!</div>
                    <div className="caution-text-p">헌법재판소에서 법률의 위헌결정, 탄핵의 결정, 정당해산의 결정 또는 헌법소원에 관한 인용결정을 할 때에는 재판관 6인 이상의 찬성이 있어야 한다.</div>
                </div>
                ...
                <div className="des_box">
                <Button type="primary" onClick={onDownloadBtn}>이미지 다운로드</Button>
                </div>
            </main>
        </>
    );
